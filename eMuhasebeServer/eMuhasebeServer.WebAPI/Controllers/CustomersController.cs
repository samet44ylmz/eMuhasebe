...
using eMuhasebeServer.Application.Features.Customers.GetAllDeletedCustomers;
using eMuhasebeServer.Application.Features.Customers.RestoreCustomer;
using eMuhasebeServer.Application.Features.Customers.PermanentDeleteCustomer;
using eMuhasebeServer.Application.Features.Customers.BulkRestoreCustomers;
using eMuhasebeServer.Application.Features.Customers.BulkPermanentDeleteCustomers;
...
public sealed class CustomersController : ApiController
{
    ...
    [HttpPost]
    public async Task<IActionResult> GetAllDeleted(GetAllDeletedCustomersQuery request, CancellationToken cancellationToken)
    {
        var response = await _mediator.Send(request, cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Restore(RestoreCustomerCommand request, CancellationToken cancellationToken)
    {
        var response = await _mediator.Send(request, cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
    ...
    [HttpPost]
    public async Task<IActionResult> PermanentDelete(PermanentDeleteCustomerCommand request, CancellationToken cancellationToken)
    {
        var response = await _mediator.Send(request, cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
    ...
    [HttpPost]
    public async Task<IActionResult> BulkRestore(BulkRestoreCustomersCommand request, CancellationToken cancellationToken)
    {
        var response = await _mediator.Send(request, cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
    ...
    [HttpPost]
    public async Task<IActionResult> BulkPermanentDelete(BulkPermanentDeleteCustomersCommand request, CancellationToken cancellationToken)
    {
        var response = await _mediator.Send(request, cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
