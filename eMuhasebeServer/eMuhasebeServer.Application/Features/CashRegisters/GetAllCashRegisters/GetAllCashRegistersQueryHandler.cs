...
internal sealed class GetAllCashRegistersQueryHandler(
    ...
    ICacheService cacheService) : IRequestHandler<GetAllCashRegistersQuery, 
        Result<List<CashRegister>>>
{
    public async Task<Result<List<CashRegister>>> Handle(GetAllCashRegistersQuery request, CancellationToken cancellationToken)
    {
        ...
        cashRegisters = cacheService.Get<List<CashRegister>>("cashRegister");
            ...
            if (cashRegisters is null)
        {
            ...
            cacheService.Set<List<CashRegister>>("cashResgisters", cashRegisters);
        }
