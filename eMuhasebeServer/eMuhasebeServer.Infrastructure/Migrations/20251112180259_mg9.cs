        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Overtime = table.Column<decimal>(type: "money", nullable: false),
                    Bonus = table.Column<decimal>(type: "money", nullable: false),
                    Allowances = table.Column<decimal>(type: "money", nullable: false),
                    TaxDeduction = table.Column<decimal>(type: "money", nullable: false),
                    SocialSecurityDeduction = table.Column<decimal>(type: "money", nullable: false),
                    HealthInsuranceDeduction = table.Column<decimal>(type: "money", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankDetailId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CustomerDetailId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    GiderId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeDetails_EmployeeDetailsId",
