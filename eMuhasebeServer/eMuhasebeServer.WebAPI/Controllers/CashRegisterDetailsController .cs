...
using eMuhasebeServer.Application.Features.CashRegisterDetails.DeleteCashRegisterById;
using eMuhasebeServer.Application.Features.CashRegisterDetails.GetAllCashRegisterDetail;
